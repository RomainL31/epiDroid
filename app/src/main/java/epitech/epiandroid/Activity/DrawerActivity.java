...
public class DrawerActivity extends MaterialNavigationDrawer<Fragment> implements MaterialAccountListener {
    ...
    public void init(Bundle savedInstanceState) {
        ...
        // create sections
        profileSection = this.newSection(getResources().getStringArray(R.array.nav_drawer_items)[0], R.drawable.home, new ProfilFragment());
        projectsSection = this.newSection(getResources().getStringArray(R.array.nav_drawer_items)[1], R.drawable.projects, new ProjetsFragment());
        planningSection = this.newSection(getResources().getStringArray(R.array.nav_drawer_items)[2], R.drawable.planning, new PlanningFragment());
        marksSection = this.newSection(getResources().getStringArray(R.array.nav_drawer_items)[4], R.drawable.grades,new NotesFragment());
        logoutSection = this.newSection("Logout", R.drawable.logout,new MaterialSectionListener() {
            @Override
