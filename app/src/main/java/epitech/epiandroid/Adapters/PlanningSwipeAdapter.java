        ...
        if (p != null) {
            ...
            try {
                if (button != null && square != null) {
                    if (p.getAllowToken() && p.getEventRegistered().equals("registered")) {
                    ...
                    } else if (p.getRegisterStudent() && p.getModuleRegistered() && p.getEventRegistered().equals("null")) {
                    ...
                    } else if (p.getRegisterStudent() && p.getEventRegistered().equals("registered")) {
                    ...
                    } else if (p.getEventRegistered().equals("present")) {
